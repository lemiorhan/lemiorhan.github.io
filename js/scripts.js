...
$(function() {
    ...
    /* Portfolio Accordion */
    $(".workspace>.content .pagearea.portfolio>div.bottom ul li h3").addClass('accordion-plus');
    $(".workspace>.content .pagearea.portfolio>div.bottom ul li h3").click(function(){
        $(".workspace>.content .pagearea.portfolio>div.bottom ul li").find('div').slideUp('fast',function(){
        });
        $(".workspace>.content .pagearea.portfolio>div.bottom ul li").find('h3').css('background-color','#999999');
        $(".workspace>.content .pagearea.portfolio>div.bottom ul li").find('h3').removeClass('accordion-minus').addClass('accordion-plus');
        if($(this).parent().children("div").css('display') === 'none'){
            $(this).css('background-color','#636363');
            $(this).removeClass('accordion-plus').addClass('accordion-minus');
